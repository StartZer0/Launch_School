...
# Answer:
# It will throw an error because greeting variable is initiliazed inside the if .. else scope and not accessible outisde the scope.
...
puts greetings
# Answer:
# {:a=>"hi there"} => informal_greeting still referencing to greetings variable.
...
# You're not returning a false condition, and you're not handling the case that there are more or fewer than 
